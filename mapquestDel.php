...
try{
	...
	$MAXDATA = 960;  //Records in the table - can't output all at once
	$STARTPOINT = 60;
...
?>
		...
		var latVal =  <?php echo json_encode($Job_Values[$i]['Latitude']); ?>;
		var longVal =  <?php echo json_encode($Job_Values[$i]['Longitude']); ?>;
		var country_code  = <?php echo json_encode($Job_Values[$i]['country_code']); ?>;
		...
		tstval = new MQA.Poi( {lat: latVal, lng: longVal});
...
<div id="map" style="width: 1158px; height: 487px;" class="auto-style1">
</div>
